...
=======
 * @version    19.1.1
>>>>>>> 8cd3f930e03ef6190906a2a085426f1ba5c230db
...
>>>>>>> 8cd3f930e03ef6190906a2a085426f1ba5c230db
   ...
   * @return object
   */
  approveAdvancedRuleScript({ accountId, scriptType } = {}) {
    var path = this.buildUrl({
   ...
   * @return string
   */
  createAdvancedRuleScript({ accountId, scriptType, crashBehavior, file } = {}) {
    var path = this.buildUrl({
   ...
   * @return string
   */
  createAdvancedRuleTable({ accountId, csvTableName, file } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteAdvancedRuleScript({ accountId, scriptType } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/accounts/${accountId}/advancedrulescripts/${scriptType}`,
      parameters: {}
    });
   ...
   * @return object[]
   */
  deleteAdvancedRuleTable({ accountId, csvTableName } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/accounts/${accountId}/advancedruletables/${csvTableName}`,
      parameters: {}
    });
   ...
   * @return object
   */
  disableAdvancedRuleScript({ accountId, scriptType } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  enableAdvancedRuleScript({ accountId, scriptType } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  getAdvancedRuleScript({ accountId, scriptType } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/accounts/${accountId}/advancedrulescripts/${scriptType}`,
      parameters: {}
    });
   ...
   * @return object
   */
  getAdvancedRuleTable({ accountId, csvTableName } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/accounts/${accountId}/advancedruletables/${csvTableName}`,
      parameters: {}
    });
   ...
   * @return object
   */
  getAdvancedRuleTables({ accountId } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  unapproveAdvancedRuleScript({ accountId, scriptType } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  queryAvaFileForms({ filter, include, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/avafileforms`,
      parameters: {
        $filter: filter,
   ...
   * @return FetchResult
   */
  listCertExpressInvitations({ companyId, include, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  createCertificates({ companyId, preValidatedExemptionReason, model } = {}) {
    var path = this.buildUrl({
   ...
   * 
     ...
     * @param string include OPTIONAL: A comma separated list of special fetch options. You can specify one or more of the following:      * customers - Retrieves the list of customers linked to the certificate.   * po_numbers - Retrieves all PO numbers tied to the certificate.   * attributes - Retrieves all attributes applied to the certificate.
     * @param string filter A filter statement to identify specific records to retrieve. For more information on filtering, see [Filtering in REST](http://developer.avalara.com/avatax/filtering-in-rest/).<br />*Not filterable:* status, pdf, pages
     * @param int top If nonzero, return no more than this number of results. Used with `$skip` to provide pagination for large datasets. Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records.
     * @param int skip If nonzero, skip this number of results before returning data. Used with `$top` to provide pagination for large datasets.
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   ...
   * @return object
   */
  requestCertificateSetup({ companyId } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/certificates/setup`,
      parameters: {}
    });
   ...
   * @return object
   */
  fundingConfigurationByCompany({ companyId } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  fundingConfigurationsByCompanyAndCurrency({ companyId, currency } = {}) {
    var path = this.buildUrl({
   ...
   * 
     ...
     * @param string filter A filter statement to identify specific records to retrieve. For more information on filtering, see [Filtering in REST](http://developer.avalara.com/avatax/filtering-in-rest/).<br />*Not filterable:* contacts, items, locations, nexus, settings, taxCodes, taxRules, upcs, exemptCerts
     * @param int top If nonzero, return no more than this number of results. Used with `$skip` to provide pagination for large datasets. Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records.
     * @param int skip If nonzero, skip this number of results before returning data. Used with `$top` to provide pagination for large datasets.
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   ...
   * @return object
   */
  linkShipToCustomersToBillCustomer({ companyId, code, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listCertificatesForCustomer({ companyId, customerCode, include, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  listValidCertificatesForCustomer({ companyId, customerCode, country, region } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  createDataSources({ companyId, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  getDataSourceById({ companyId, id } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/datasources/${id}`,
      parameters: {}
    });
   ...
   * @return FetchResult
   */
  listDataSources({ companyId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/datasources`,
      parameters: {
        $filter: filter,
   ...
   * @return FetchResult
   */
  queryDataSources({ filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  updateDataSource({ companyId, id, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/datasources/${id}`,
      parameters: {}
    });
   ...
   * @return FetchResult
   */
  getCrossBorderCode({ country, hsCode } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listCrossBorderCodes({ country, hsCode, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listCurrencies({ filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   *
   * 
     * @param string filter A filter statement to identify specific records to retrieve. For more information on filtering, see [Filtering in REST](http://developer.avalara.com/avatax/filtering-in-rest/).<br />*Not filterable:* streamlinedSalesTax, taxAuthorityId
     * @param int top If nonzero, return no more than this number of results. Used with `$skip` to provide pagination for large datasets. Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records.
     * @param int skip If nonzero, skip this number of results before returning data. Used with `$top` to provide pagination for large datasets.
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return FetchResult
   ...
   * @return FetchResult
   */
  listParametersByItem({ companyCode, itemCode, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listPostalCodes({ filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listPreferredPrograms({ filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listProductClassificationSystems({ filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listProductClassificationSystemsByCompany({ companyCode, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listTaxForms({ filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listUnitOfMeasurement({ filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  createDistanceThreshold({ companyId, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteDistanceThreshold({ companyId, id } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  getDistanceThreshold({ companyId, id } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/distancethresholds/${id}`,
      parameters: {}
    });
   ...
   * @return FetchResult
   */
  listDistanceThresholds({ companyId, filter, include, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/distancethresholds`,
      parameters: {
        $filter: filter,
   ...
   * @return FetchResult
   */
  queryDistanceThresholds({ filter, include, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  updateDistanceThreshold({ companyId, id, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/distancethresholds/${id}`,
      parameters: {}
    });
   ...
   * 
     * @param int companyId The ID of the company that owns these batches
     * @param string filter A filter statement to identify specific records to retrieve. For more information on filtering, see [Filtering in REST](http://developer.avalara.com/avatax/filtering-in-rest/).<br />*Not filterable:* formCountry, formRegion, taxFormCode, taxAuthorityId, taxAuthorityName, taxAuthorityType, settings
     * @param int top If nonzero, return no more than this number of results. Used with `$skip` to provide pagination for large datasets. Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records.
     * @param int skip If nonzero, skip this number of results before returning data. Used with `$top` to provide pagination for large datasets.
     * @param string orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   ...
   * @return FetchResult
   */
  listFilingRequests({ companyId, filingCalendarId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  queryFilingRequests({ filingCalendarId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  getFilingAttachment({ companyId, filingReturnId, fileId } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  getFilingReturn({ companyId, id, details } = {}) {
    var path = this.buildUrl({
...
This gets the basic information from the filings and doesn't include anything extra.
   ...
   * @return FetchResult
   */
  getFilingsReturns({ companyId, endPeriodMonth, endPeriodYear, frequency, status, country, region, filingCalendarId } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  createItemClassifications({ companyId, itemId, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  createItemParameters({ companyId, itemId, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteItemClassification({ companyId, itemId, id } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteItemParameter({ companyId, itemId, id } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  getItemClassification({ companyId, itemId, id } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/items/${itemId}/classifications/${id}`,
      parameters: {}
    });
   ...
   * @return object
   */
  getItemParameter({ companyId, itemId, id } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/items/${itemId}/parameters/${id}`,
      parameters: {}
    });
   ...
   * @return FetchResult
   */
  listItemClassifications({ companyId, itemId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/items/${itemId}/classifications`,
      parameters: {
        $filter: filter,
   ...
   * @return FetchResult
   */
  listItemParameters({ companyId, itemId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/items/${itemId}/parameters`,
      parameters: {
        $filter: filter,
   ...
   * @return object
   */
  updateItemClassification({ companyId, itemId, id, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/items/${itemId}/classifications/${id}`,
      parameters: {}
    });
   ...
   * @return object
   */
  updateItemParameter({ companyId, itemId, id, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/items/${itemId}/parameters/${id}`,
      parameters: {}
    });
   ...
   * @return object
   */
  adjustMultiDocumentTransaction({ code, type, include, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  auditMultiDocumentTransaction({ code, type } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  commitMultiDocumentTransaction({ model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  createMultiDocumentTransaction({ include, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  getMultiDocumentTransactionByCodeAndType({ code, type, include } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  getMultiDocumentTransactionById({ id, include } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listMultiDocumentTransactions({ filter, include, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/transactions/multidocument`,
      parameters: {
        $filter: filter,
   ...
   * @return object
   */
  refundMultiDocumentTransaction({ code, type, include, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  verifyMultiDocumentTransaction({ model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  voidMultiDocumentTransaction({ code, type, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  declareNexusByAddress({ companyId, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteCommentDetails({ companyId, id, commentDetailsId } = {}) {
    var path = this.buildUrl({
   ...
   * @return object[]
   */
  deleteFinanceDetails({ companyId, id, financeDetailsId } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  updateFinanceDetails({ companyId, noticeid, financeDetailsId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/notices/${noticeid}/financedetails/${financedetailsid}`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'put', payload: model });
  }
   ...
   * @return object
   */
  updateNoticeComments({ companyId, noticeid, commentDetailsId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/notices/${noticeid}/commentdetails/${commentdetailsid}`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'put', payload: model });
  }
  ...
  dismissNotification({ id } = {}) {
    ...
    return this.restCall({ url: path, verb: 'put', payload: null });
  }
   ...
   * @return FetchResult
   */
  listNotifications({ filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  requestNewEntitlement({ id, offer } = {}) {
    var path = this.buildUrl({
   ...
   * @return string
   */
  resetPassword({ userId, unmigrateFromAi, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/passwords/${userId}/reset`,
      parameters: {
        unmigrateFromAi: unmigrateFromAi
      }
    });
    return this.restCall({ url: path, verb: 'post', payload: model });
  }
   ...
   * @return object
   */
  downloadTaxRatesByZipCode({ date, region } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  adjustTransaction({ companyCode, transactionCode, documentType, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  changeTransactionCode({ companyCode, transactionCode, documentType, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  commitTransaction({ companyCode, transactionCode, documentType, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  getTransactionByCode({ companyCode, transactionCode, documentType, include } = {}) {
    var path = this.buildUrl({
   ...
   * @return FetchResult
   */
  listTransactionsByCompany({ companyCode, dataSourceId, include, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  lockTransaction({ companyCode, transactionCode, documentType, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  refundTransaction({ companyCode, transactionCode, include, documentType, useTaxDateOverride, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  settleTransaction({ companyCode, transactionCode, documentType, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  uncommitTransaction({ companyCode, transactionCode, documentType } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  verifyTransaction({ companyCode, transactionCode, documentType, model } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  voidTransaction({ companyCode, transactionCode, documentType, model } = {}) {
    var path = this.buildUrl({
